<!--  ****************************  This Page is For Ticket Booking Facility for Admin  ***********************  -->
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Ticket Booking Form<hr></h2>
              ...
              <form action="confirmbooking.php" method="post">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    ...
                    <!--<button type="submit" class="btn btn-primary btnchng" name="verify" onclick="GetDetail(this.value)">Verify</button>-->
                  </div>
                </div>
<!--
                <div class="row mb-3">
...
-->
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="Source Location" name="source">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="Destination Location" name="dest">
                  </div>
                </div>

                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label">Bus Code</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Bus Code" name="buscode">
                  </div>
                </div>
