    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Create Bus Schedule <hr></h2>
...
-->
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Create Bus Code" name="buscode">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Fare" name="fare">
                  </div>
                </div>
