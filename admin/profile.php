              ...
              <div class="tab-content pt-2">
                ...
                <div>
                  ...
                  <form action="admin-profile.php" method="post">
                    <div>
                        <label><h2>Admin Profile</h2></label><hr><br>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-4 col-lg-4">
                        <input name="age" type="text" class="form-control" id="age" value="" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-4 col-lg-4">
                        <input name="gender" type="text" class="form-control" id="gender" value="" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6 col-lg-6">
                        <input name="contact" type="text" class="form-control" id="contact" value="" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="created_on" type="text" class="form-control" id="Created_on" value="" disabled>
                      </div>
                    </div>
