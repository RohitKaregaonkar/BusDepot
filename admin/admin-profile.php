<!--  ****************************  This Page is For User to Display Profile to Admin   ***********************  -->

<?php 
    include_once('DBConnect.php');
    $username = $_REQUEST['username'];
    $res=mysqli_query($conn,"select * from admins where username='$username'");
              ...
              <div class="tab-content pt-2">
                ...
                <div>
                  ...
                  <form action="update-profile.php" method="post">
                    ...
                    <div>
                        <label><h2>User Profile</h2></label><hr><br>
                    </div>
                      
                    <div class="row mb-3">
                      <label for="username" class="col-md-4 col-lg-3 col-form-label">Username</label>
                      <div class="col-md-6 col-lg-6">
                        <input name="username" type="text" class="form-control" id="username" value="<?php echo $rows['username']; ?>" disabled>
                      </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-8">
                          <input name="fullName" type="text" class="form-control" id="fullName" value="<?php echo $rows['fullname']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-4 col-lg-4">
                        <input name="age" type="text" class="form-control" id="age" value="<?php echo $rows['age']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-4 col-lg-4">
                        <input name="gender" type="text" class="form-control" id="gender" value="<?php echo $rows['gender']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6 col-lg-6">
                        <input name="contact" type="text" class="form-control" id="contact" value="<?php echo $rows['contact']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="age" class="col-md-4 col-lg-3 col-form-label">Created on</label>
                      <div class="col-md-6 col-lg-6">
                        <input name="created_on" type="text" class="form-control" id="Created_on" value="<?php echo $rows['created_on']; ?>" disabled>
                      </div>
                    </div>
