<!--  ****************************  This Page is For User to Display Schedule of Available Buses   ***********************  -->
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><center>View Schedule</center></h5>
              ...
              <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Distance <br> (in Kms)</th>
                    <th scope="col">Fare <br>(Rs.)</th>
                  </tr>
                </thead>
                <tbody>
