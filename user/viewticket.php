<!--  ****************************  This Page is For Ticket Booking Facility for Both  ***********************  -->
...
<head>
  ...
  <title>User : View Ticket Form</title>
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">View Ticket</h2><br>

              <!-- *************************************** Ticket Booking Form Starts Here ********************************** -->
              <form action="viewuserticket.php" method="post">
